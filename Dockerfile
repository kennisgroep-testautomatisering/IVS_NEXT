...
RUN wget -q "https://raw.githubusercontent.com/kennisgroep-testautomatisering/IVS_NEXT/master/aangepaste_versie/TC_01.py" -O /var/dumps/TC_01.py

RUN wget -q "https://raw.githubusercontent.com/kennisgroep-testautomatisering/IVS_NEXT/master/aangepaste_versie/page.py" -O /var/dumps/page.py

RUN wget -q "https://raw.githubusercontent.com/kennisgroep-testautomatisering/IVS_NEXT/master/aangepaste_versie/uitvoering_UI_BP_1.py" -O /var/dumps/uitvoering_UI_BP_1.py

RUN wget -q "https://raw.githubusercontent.com/kennisgroep-testautomatisering/IVS_NEXT/master/aangepaste_versie/voorbereiding_UI_BP_1.py" -O /var/dumps/voorbereiding_UI_BP_1.py
